# imgui-framebuffer Versioning

This document applies to all versions of imgui-framebuffer.
...
The build number is the number of days since September 1, 2026 because that day
I start to make imgui-framebuffer. 
